...
public class BlogRepository : IBlogRepository
{
    ...
    {
        var tagQuery = _context.Set<User>()
    ...
    public async Task<User> FindTagWithSlugAsync(
            string slug,
            CancellationToken cancellationToken = default)
    {
        IQueryable<User> tagsQuery = _context.Set<User>();
        if (!string.IsNullOrWhiteSpace(slug))
        {
    ...
    public async Task<IList<TagItem>> GetTagsItemsAsync(
        CancellationToken cancellationToken = default)
    {
        var tagItemsQuery = _context.Set<User>();
            ...
            CancellationToken cancellationToken = default)
    {
        ...
        foreach (var kv in validTags)
        {
            ...
            var tag = await FindTagWithSlugAsync(kv.Key, cancellationToken) ?? new User()
            {
                Name = kv.Value,
    ...
    public async Task<User> GetTagAsync(
        string slug, CancellationToken cancellationToken = default)
    {
