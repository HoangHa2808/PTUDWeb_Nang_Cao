    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="languageDropdown">
          ...
          <a href="{{ url('/general/profile') }}" class="dropdown-item py-2"><i class="flag-icon flag-icon-vn" title="vn" id="vn"></i> <span class="ml-1"> Vietnam </span></a>
        ...
        <div class="dropdown-menu" aria-labelledby="appsDropdown">
          ...
          <div class="dropdown-body">
            <div class="d-flex align-items-center apps">
                <a href="{{ url('/posts/tours') }}"><i data-feather="calendar" class="icon-lg"></i><p>Posts</p></a>
              <a href="{{ url('/user/index') }}"><i data-feather="users" class="icon-lg"></i><p>User</p></a>
