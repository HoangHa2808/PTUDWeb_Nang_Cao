    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('posts.hotel.store') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="ratting">Hạng sao</label>
                            <input type="char" class="form-control" id="ratting" name="ratting"
                                class="@error('ratting') is-invalid @enderror" placeholder="*****" />
                            @error('ratting')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="discount">Giá</label>
                            <input type="number" class="form-control" id="discount" name="discount"
                                class="@error('discount') is-invalid @enderror" placeholder="3500000" />
                            @error('discount')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-check-inline mt-3">
                                <input class="form-check-input" type="checkbox" id="published" value="true" />
