                                ...
                                <table id="dataTableExample" class="table">
                                    ...
                                    <tbody>
                                        @foreach ($hotels as $hotel)
                                            <tr>
                                                <td>{{ $hotel->id }}</td>
                                                <td class=""> <div style="width:200px; overflow:hidden;"><a href="/posts/hotel/edit/{{ $hotel->id }}">
                                                ...
                                                <td class=""> <div style="width:300px; overflow:hidden;">{{ $hotel->short_description }}</div></td>
                                                <td class=""> <div style="width:300px; overflow:hidden;">{{ $hotel->description }} </div></td>
