            ...
            <div class="col-12 grid-margin">
                <div class="profile-header">
                    <div class="cover">
                        ...
                        <figure>
                            <img src="1.ico" class="img-fluid" alt="profile" >
                        </figure>
                    </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item d-flex align-items-center" href="#"><i
                                            data-feather="edit-2" class="icon-sm mr-2"></i> <span class="">Chỉnh
                                            sửa</span></a>
                                    <a class="dropdown-item d-flex align-items-center" href="#"><i
                                            data-feather="git-branch" class="icon-sm mr-2"></i> <span class="">Cập
                                            nhật</span></a>
                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card rounded">
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img class="img-xs rounded-circle" src="{{ url('admin2.jpg') }}" alt="">
                                        <div class="ml-2">
                                            <p>Nhật Hạ</p>
                            ...
                            <div class="card-body">
                                ...
                                <img class="img-fluid" src="{{ url('1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card rounded">
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img class="img-xs rounded-circle" src="{{ url('3.jpg') }}" alt="">
                                        <div class="ml-2">
                                            <p>Mike Popescu</p>
                            ...
                            <div class="card-body">
                                ...
                                <img class="img-fluid" src="{{ url('staff4.jpg') }}" alt="">
                            </div>
                            <div class="card-footer">
                                <div class="d-flex post-actions">
                                    <a href="javascript:;" class="d-flex align-items-center text-muted mr-4">
