...
public class SubscriberRepository : ISubscriberRepository
{
    ...
    public async Task<IList<Subscriber>> GetSubscriberAsync(CancellationToken cancellationToken = default)
    {
        IQueryable<Subscriber> subscribers = _context.Set<Subscriber>();
