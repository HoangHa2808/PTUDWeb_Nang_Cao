        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribeState = table.Column<int>(type: "int", nullable: false),
                    UnsubscribeState = table.Column<int>(type: "int", nullable: false),
                    Reasons = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timetable = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Prices = table.Column<float>(type: "real", maxLength: 50, nullable: false),
                    ...
                    PostsTypeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_PostsType_PostsTypeId",
                        column: x => x.PostsTypeId,
