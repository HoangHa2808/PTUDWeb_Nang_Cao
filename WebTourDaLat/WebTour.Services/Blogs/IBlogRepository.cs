...
namespace WebTour.Services.Blogs
{
    public interface IBlogRepository
    {
     ...
     CancellationToken cancellationToken = default);
        ...
        Task<Posts> GetPostByIdAsync(
        int postId, bool includeDetails = false,
        CancellationToken cancellationToken = default);

        Task<Posts> GetPostBySlugAsync(
       ...
       CancellationToken cancellationToken = default);
        ...
        Task<Posts> FindPostByIDAsync(int id, CancellationToken cancellationToken = default);

        // 1.m: Thêm hay cập nhật một bài viết
        Task AddOrUpdatePostAsync(Posts postsName, CancellationToken cancellationToken = default);

        Task<Posts> CreateOrUpdatePostAsync(
        ...
        Task<IList<Posts>> GetRandomPostsAsync(
            int n,
            CancellationToken cancellationToken = default);
        ...
        Task<IList<Posts>> GetAllPostsByPostQuery(
        ...
        Task<IList<Posts>> FindAllPostsWithPostQueryAsync(
            PostsQuery pq,
            CancellationToken cancellationToken = default);
        ...
        Task<IPagedList<Posts>> GetPagedsPostAsync(PostsQuery pq,
            IPagingParams pagingParams,
            CancellationToken cancellationToken = default);

        IQueryable<Posts> FilterPost(PostsQuery pq);
        ...
        Task<IPagedList<Posts>> GetPagedPostAsync(
                PostsQuery pq,
                int pageNumber = 1,
                int pageSize = 10,
                CancellationToken cancellationToken = default);
        ...
        Task<Posts> GetCachedPostByIdAsync(int postId);
