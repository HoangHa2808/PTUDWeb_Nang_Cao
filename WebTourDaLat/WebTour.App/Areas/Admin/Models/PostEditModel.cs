...
namespace WebTour.WebApp.Areas.Admin.Models
{
    public class PostEditModel
    {
        ...
        [Required(ErrorMessage = "Hành trình không được để trống")]
        [MaxLength(500, ErrorMessage = "Hành trình tối đa 500 ký tự")]
        public string Schedule { get; set; }

        [DisplayName("Thời gian của tour")]
        [Required(ErrorMessage = "Thời gian của tour không được để trống")]
        public string Timetable { get; set; }

        [DisplayName("Giá khách sạn")]
        [Required(ErrorMessage = "Giá khách sạn không được để trống")]
        ...
        [Required(ErrorMessage = "Bạn chưa chọn loại bài viết")]
        ...
        public IEnumerable<SelectListItem> PostsTypeList { get; set; }
